        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedServicePrice = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockoutEnd = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "('0001-01-01T00:00:00.000')")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "('0001-01-01T00:00:00.000')"),
                    PaymentDueDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "('0001-01-01T00:00:00.000')"),
                    PaymentStatus = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    PostalCode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ShippingDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "('0001-01-01T00:00:00.000')"),
